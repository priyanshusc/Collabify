    ...
    <div className="flex w-full bg-white overflow-hidden shadow-2xl">
      ...
      <div className="flex flex-col justify-between flex-[1.4] bg-gradient-to-br from-indigo-700 to-indigo-900 p-14 text-white relative">
        ...
        <div className="relative z-10">
          <h1 className="text-5xl font-bold mb-3">Hello Collabify! 👋</h1>
          <p className="text-indigo-100 text-base leading-relaxed">
            Collaborate effortlessly with your team.  
            Boost productivity, automate routine work,  
          ...
          <form onSubmit={onSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                onChange={onChange}
                required
                className="w-full text-gray-900 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={onChange}
                required
                className="w-full px-4 py-2 border text-gray-900 border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none"
              />
            </div>
            ...
            >
              ...
              <span className='text-slate-900 font-medium text-sm pl-1'>Login with Google</span>
            </button>
          </form>
